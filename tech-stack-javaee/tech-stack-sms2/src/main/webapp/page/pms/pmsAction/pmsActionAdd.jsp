...
<div class="pageContent">
	<form id="form1" method="post" action="pmsPermission_pmsActionSave.action" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="58">
			...
			<p>
				<label>权限名称：</label>
				<input type="text" name="actionName" class="required" minlength="3" maxlength="30" size="30" />
			</p>
			<p>
				<label>权限标识：</label>
				<input type="text" name="action" class="required" minlength="3" maxlength="30" size="30" />
			...
			<p>
				...
				<a class="btnLook" href="pmsPermission_pmsMenuLookUpUI.action" lookupgroup="menu" width="350">菜单模块</a>
			</p>
			<p style="width:99%">
				<label></label>
