package com.techstack.sms2.base.dwz;
...
/*	*//**	
	 * 关闭当前Tab，在点击tab出现返回错误提示框时，Tab页是空白的，加这个参数返回去关掉TAB（operateErrorAndCloseTab）	
	 * "true":启用，"false":不启用
	 *//*
	private String closeCurrentTab;*/
...
/*	*//**
	 * @return the closeCurrentTab
	 *//*
	public String getCloseCurrentTab() {
		return closeCurrentTab;
	}

	*//**
	 * @param closeCurrentTab the closeCurrentTab to set
	 *//*
	public void setCloseCurrentTab(String closeCurrentTab) {
